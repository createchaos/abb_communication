...
class ABBCommunication(ClientContainer):
    ...
    def send_single_move_command(self, input, ext_axes, num_cmd, int_arr = None):
        """ create command from plane or joint values and send to robot
    ...
    # =================================================================================
    def send_pose_cartesian(self, plane, ext_axes_in = [100000, 100000, 100000], int_arr=None):
    ...
    # =================================================================================
    def send_pose_cartesian_joints(self, plane, ext_axes_in = [100000, 100000, 100000], int_arr=None):
        """ create command from plane and send task target to robot,
        int_arr can be defined outside, or if None, default values are sent.
        int_arr = [int_speed, float_duration, int_zonedata, int_tool, float_arbitrary, int_wobj] 
        ext_axes values are optional, either in list format or as single float value for only one axis"""
    ...
    # =================================================================================
    def send_pose_cartesian_list(self, planes, ext_axes_in=None, int_arr=None):
        ...
        for i, plane in enumerate(planes):
            self.send_pose_cartesian(plane, ext_axes_list[i], int_arr)
    ...
    def send_pick_rod_from_feed(self, plane, ext_axes, int_arr = None):
    ...
    def send_mill_rod(self, plane1, plane2, ext_axes1, ext_axes2, jointpos_1, jointpos_2, int_arr=None):
        ...
        frame = Frame(plane_local_1)
        pose_1 = frame.get_pose_quaternion() # pose = [x,y,z,qw,qx,qy,qz]
        ...
        frame = Frame(plane_local_2)
        pose_2 = frame.get_pose_quaternion() # pose = [x,y,z,qw,qx,qy,qz]
    ...
    def send_regrip_rod(self, plane1, plane2, ext_axes1, ext_axes2, int_arr=None):
    ...
    # ========================== funcions andreas ===============================================
    def send_stu_pick(self, plane, ext_axes, int_arr=None):
        """ create command from plane and send pick command to robot,
        int_arr can be defined outside, or if None, default values are sent.
        int_arr = [int_speed, float_duration, int_zonedata, int_tool, float_arbitrary, int_wobj] """
    ...
    def send_stu_place(self, plane_1, plane_2, ext_axes_1, ext_axes_2, int_arr=None):
        """ create command from plane and send pick command to robot,
        int_arr can be defined outside, or if None, default values are sent.
        int_arr = [int_speed, float_duration, int_zonedata, int_tool, float_arbitrary, int_wobj] """

        frame_1 = Frame(plane_1)
        pose_1 = frame_1.get_pose_quaternion() # pose = [x,y,z,qw,qx,qy,qz]
        if int_arr == None:
        ...
        frame_2 = Frame(plane_2)
        pose_2 = frame_2.get_pose_quaternion() # pose = [x,y,z,qw,qx,qy,qz]
        if int_arr == None:
    ...
    # ========================== funcions MAS ===============================================
    def send_mas_pick_brick(self, plane, ext_axes, int_arr=None):
        """ create command from plane and send pick command to robot,
        int_arr can be defined outside, or if None, default values are sent.
        int_arr = [int_speed, float_duration, int_zonedata, int_tool, float_arbitrary, int_wobj] """
    ...
    def send_mas_place_brick(self, plane, ext_axes, int_arr=None):
        """ create command from plane and send place command to robot,
        int_arr can be defined outside, or if None, default values are sent.
        int_arr = [int_speed, float_duration, int_zonedata, int_tool, float_arbitrary, int_wobj] """
    ...
    def send_mas_pick_brick_magazine(self, plane, ext_axes, int_arr=None):
        """ create command from plane and send pick command to robot,
        int_arr can be defined outside, or if None, default values are sent.
        int_arr = [int_speed, float_duration, int_zonedata, int_tool, float_arbitrary, int_wobj] """
    ...
    def send_mas_place_brick_magazine(self, plane, ext_axes, int_arr=None):
        """ create command from plane and send place command to robot,
        int_arr can be defined outside, or if None, default values are sent.
        int_arr = [int_speed, float_duration, int_zonedata, int_tool, float_arbitrary, int_wobj] """
