MODULE ETH_Fat_21
    ...
    PROC rWorkspace()
        ...
        MoveAbsJ jpTemp,vFatWorSpa,fine,tool0;
        !
        ! Gantry 21 X-Axis done
        WaitSyncTask idETH_FatMoveMinDoneX21,tlAll;
        !
        ! Start with Gantry21 X-Axis Max
        !
    ...
    PROC rRefPoint()
        ...
        WHILE bFatRefPointOn=TRUE DO
            ...
            IF bNoJobROB21=FALSE THEN
                ...
                \MsgLine2:="ROB21 is free to move?"
                \MsgLine3:="ROB22 is free to move?"
